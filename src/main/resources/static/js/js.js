...
//
// function transportOrderGetAssignment(assignmentId) {
//     $.ajax({
//         type: 'GET',
//         url: 'http://localhost:8080/transportOrder/addTransportOrder',
//         data: {'assignmentId': assignmentId},
//         redirect: 'http://localhost:8080/transportOrder/addTransportOrder',
//         success: function (data) {
//             console.log(data);
//         }
//         });
...
// function indicatorsViewYear(id ,date) {
//       $.ajax({
//           type: 'POST',
//           url: 'http://localhost:8080/indicator/track',
//           data: {'counterId': id, 'year': date},
//           success: function (data) {
//               console.log(data);
//
//               // window.location.reload();
